...
void RootSignatureBuilder::AddHeapRangesParameter(
...
// will be bound.
void RootSignatureBuilder::AddRootParameter(D3D12_ROOT_PARAMETER_TYPE type,
...
ID3D12RootSignature* RootSignatureBuilder::Generate(ID3D12Device * device, bool isLocal)
{
