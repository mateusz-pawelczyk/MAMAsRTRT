...
[shader("closesthit")] void SphereClosestHit(inout HitInfo payload,
	...
	payload.colorAndDistance = float4(factor * (reflectionPayload.colorAndDistance.xyz *0.0f + diffusePayload.colorAndDistance.xyz * 5.f + .5f * float3(0.0f, 0.4, 0.6)), RayTCurrent());
